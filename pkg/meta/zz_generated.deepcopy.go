...
func (in *CassandraDatacenterResourceMeta) DeepCopyInto(out *CassandraDatacenterResourceMeta) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraDatacenterResourceMeta.
func (in *CassandraDatacenterResourceMeta) DeepCopy() *CassandraDatacenterResourceMeta {
	if in == nil {
		return nil
	}
	out := new(CassandraDatacenterResourceMeta)
	in.DeepCopyInto(out)
	return out
}
