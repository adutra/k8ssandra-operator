...
func TestNewService(t *testing.T) {
	...
	labels := utils.MergeMap(reaper.Spec.ReaperTemplate.Meta.Services.Labels, commonLabels)
	labels = utils.MergeMap(reaper.Spec.ReaperTemplate.Meta.CommonLabels, labels)
