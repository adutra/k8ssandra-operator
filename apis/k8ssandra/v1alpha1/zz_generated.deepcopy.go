...
func (in *CassandraClusterTemplate) DeepCopyInto(out *CassandraClusterTemplate) {
	*out = *in
	...
	if in.Meta != nil {
		...
		*out = new(meta.CassandraDatacenterResourceMeta)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *EmbeddedObjectMeta) DeepCopyInto(out *EmbeddedObjectMeta) {
	*out = *in
	if in.CassandraDatacenterResourceMeta != nil {
		in, out := &in.CassandraDatacenterResourceMeta, &out.CassandraDatacenterResourceMeta
		*out = new(meta.CassandraDatacenterResourceMeta)
		(*in).DeepCopyInto(*out)
	}
}
